      ...
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        ...
        <div>
          ...
          <p className="text-base md:text-lg">
            My name is Nami Miyashiro, born and raised in Japan. I am a front-end developer based in Vancouver, Canada. I like coding, designing, cats, and traveling aroud the world.
          </p>
